...
use Vanta\Integration\Esia\Struct\Document\Passport\RussianPassportSeries;
use Webmozart\Assert\Assert;

final readonly class RussianPassportSeriesNormalizer implements Normalizer, Denormalizer
{
    /**
    ...
    {
        return [RussianPassportSeries::class => true];
    }
